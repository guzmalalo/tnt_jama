...
namespace JAMA
{
  ...
  /**
 * @brief Computes eigenvalues and eigenvectors of a T (non-complex)
 * matrix. 
 * 
 ...
 * the identity matrix.  The columns of V represent the eigenvectors 
 * in the sense that A*V = V*D.
 * 
 * If A is not symmetric, then the eigenvalue matrix D is block diagonal
 * with the T eigenvalues in 1-by-1 blocks and any complex eigenvalues,
 ...
 * @endcode
 *
 * This keeps V a T matrix in both symmetric and non-symmetric 
 * cases, and A*V = V*D.
 * 
 * The matrix V may be badly conditioned, or even singular, 
 * so the validity of the equation A = V*D*inverse(V) depends upon the 
 ...
 */
  ...
  class Eigenvalue
  {
    ...
    TNT::Array1D<T> d; /* T part */
    TNT::Array1D<T> e; /* img part */
    ...
    // Nonsymmetric reduction from Hessenberg to T Schur form.
 ...
 * 
 * @param A Square T (non-complex) matrix
 */
    Eigenvalue(const TNT::Array2D<T> &A)
    {
      ...
      else
      {
        ...
        // Reduce Hessenberg to T Schur form.
        hqr2();
      }
    }
 ...
 */
 ...
 /**
 * @brief Computes the block diagonal eigenvalue matrix.If the original
 * matrix A is not symmetric, then the eigenvalue matrix D is block diagonal
 * with the T eigenvalues in 1-by-1 blocks and any complex eigenvalues, 
 * a + i*b, in 2-by-2 blocks, [a, b; -b, a].  That is, if the complex 
 * eigenvalues look like:
 * 
